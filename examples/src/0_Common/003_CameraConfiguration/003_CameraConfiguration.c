...
BGAPI2_RESULT setDeviceParameter(BGAPI2_Device* pDevice) {
    ...
    char userName[1024] = "";
    char myString[1024] = "";
    bo_int64  iStringlength = (bo_int64)sizeof(myString);
    bo_uint64 uStringlength = sizeof(myString);
    ...
    if (BGAPI2_Node_GetDescription(pNode, myString, &uStringlength) != BGAPI2_RESULT_SUCCESS) return BGAPI2_RESULT_ERROR;
    printf("          description:            %s\n", myString);
    uStringlength = sizeof(myString);
    if (BGAPI2_Node_GetInterface(pNode, myString, &uStringlength) != BGAPI2_RESULT_SUCCESS) return BGAPI2_RESULT_ERROR;
    ...
    if (BGAPI2_Node_GetInterface(pNode, myString, &uStringlength) != BGAPI2_RESULT_SUCCESS) return BGAPI2_RESULT_ERROR;
    printf("          interface type:         %s\n", myString);
    uStringlength = sizeof(sEnumNodeValueCurrent);
    if (BGAPI2_Node_GetValue(pNode, sEnumNodeValueCurrent, &uStringlength) != BGAPI2_RESULT_SUCCESS) return BGAPI2_RESULT_ERROR;
    ...
    for (iIndexEnumNodeList = 0; iIndexEnumNodeList < iEnumNodeListCount; iIndexEnumNodeList++) {
        ...
        if (bReadable) {
            uStringlength = sizeof(myString);
            if (BGAPI2_Node_GetValue(pEnumEntry, myString, &uStringlength) != BGAPI2_RESULT_SUCCESS) return BGAPI2_RESULT_ERROR;
    ...
    uStringlength = sizeof(myString);
    if (BGAPI2_Node_GetValue(pNode, myString, &uStringlength) != BGAPI2_RESULT_SUCCESS) return BGAPI2_RESULT_ERROR;
    printf("          set value to:           %s\n", myString);
    ...
    if (BGAPI2_Node_GetInterface(pNode, myString, &uStringlength) != BGAPI2_RESULT_SUCCESS) return BGAPI2_RESULT_ERROR;
    printf("          interface type:         %s\n", myString);
    uStringlength = sizeof(userName);
    if (BGAPI2_Node_GetValue(pNode, userName, &uStringlength) != BGAPI2_RESULT_SUCCESS) return BGAPI2_RESULT_ERROR;
    printf("          current value:          %s\n", userName);
    ...
    if (strlen(myString) < (size_t)iStringlength) {
