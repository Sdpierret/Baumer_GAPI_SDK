...
set_target_properties(bgapi::bgapi2_genicam PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libbgapi2_genicam.so.2.12.0"
  IMPORTED_SONAME_RELEASE "libbgapi2_genicam.so.2.12"
  )

list(APPEND _IMPORT_CHECK_TARGETS bgapi::bgapi2_genicam )
list(APPEND _IMPORT_CHECK_FILES_FOR_bgapi::bgapi2_genicam "${_IMPORT_PREFIX}/lib/libbgapi2_genicam.so.2.12.0" )
